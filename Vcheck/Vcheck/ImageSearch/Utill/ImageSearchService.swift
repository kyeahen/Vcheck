...
struct ImageUploadService: APIService {
     ...
     */
    static func postImage(image: UIImage, completion: @escaping (Product) -> Void) {
...
//                            let courseData = try decoder.decode([Course].self, from: value)
//
//                            print(JSON(value))
//                            let emotion = JSON(value)["food_name"].string
//
//                            completion(emotion ?? "")
//                        }
                        ...
                        if let value = res.result.value {
                            ...
                            do {
                                let data = try decoder.decode(Product.self, from: value)
